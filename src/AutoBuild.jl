...
function build_jll_package(src_name::String,
    ...
    open(joinpath(code_dir, "README.md"), "w") do io
        ...
        if is_yggdrasil
            print(io, " The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/$(ygg_head)/$(ENV["PROJECT"])/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.")
        end
        println(io)
        println(io)
