...
function build_jll_package(src_name::String,
    ...
    open(joinpath(code_dir, "README.md"), "w") do io
        println(io,
                ...
                """)
        if is_yggdrasil()
            println(io, "[![deps](https://juliahub.com/docs/$(src_name)_jll/deps.svg)](https://juliahub.com/ui/Packages/$(src_name)_jll/$(Base.package_slug(BinaryBuilder.jll_uuid("$(src_name)_jll"), 5))?t=2)\n")
        end
        print(io, """
