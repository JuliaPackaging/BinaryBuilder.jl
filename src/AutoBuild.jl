...
function rebuild_jll_package(name::String, build_version::VersionNumber, sources::Vector,
                             ...
                             from_scratch::Bool = true, from_yggdrasil::Bool = false)
    ...
    for platform in platforms
        ...
        build_jll_package(name, build_version, sources, code_dir, build_output_meta, dependencies, upload_prefix; verbose=verbose, lazy_artifacts=lazy_artifacts, from_yggdrasil=from_yggdrasil)
    end
end
...
function build_jll_package(src_name::String,
    ...
    print_source(io, ::DirectorySource) = nothing
    ...
    open(joinpath(code_dir, "README.md"), "w") do io
        ...
        if from_yggdrasil
            print(io, " The recipe can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.")
        end
        println(io)
        println(io)
        ...
        print(io, """
                  ...
                  The code of this Julia library is released under the terms of the MIT "Expat" License.  This license does not apply to the binary package wrapped by the present library and whose license is shipped in the accompanying tarball.
                  """)
    end
